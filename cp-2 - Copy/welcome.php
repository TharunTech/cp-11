...
<body class="u-body u-xxl-mode">
            ...
            <div class="row text-center align-items-center justify-content-center" style="height: 100vh;">
                <div class="col-sm-12 col-md-6 mx-auto" >
                    <h1 class="text-white mb-5" style="font-size: 6rem;">
                        Visitor Pass successfully created
                    </h1>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-30 u-footer" id="sec-e1bb"><div class="u-clearfix u-sheet u-sheet-1" style="padding-left: 10px;">
        ...
        <div class="container-fluid"id="id_tt">
            <div class="row text-center align-items-center justify-content-center" >
                  <img src="./uploadPhoto/22.png" alt="">
                   <img src="./uploadPhoto/temp.jpeg" class="no4" alt="">
                  <h1 class="name">
